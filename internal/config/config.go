...
func getEnvValues() {
	...
	if err != nil {
		logger.Error(fmt.Sprintf("fail parse env params: %v", err), map[string]interface{}{})
		return
	}
	...
	if envValues.HasRunAddress() {
		...
		if err != nil {
			logger.Error(fmt.Sprintf("fail set RunAddress from env params: %v", err), map[string]interface{}{})
		}
	}
	...
	if envValues.HasDBUri() {
		...
		if err != nil {
			logger.Error(fmt.Sprintf("fail set DBUri from env params: %v", err), map[string]interface{}{})
		}
	}
	...
	if envValues.HasAccrualSystemUrl() {
		...
		if err != nil {
			logger.Error(fmt.Sprintf("fail set AccrualSystemUrl from env params: %v", err), map[string]interface{}{})
		}
	}
}
...
func getFlagsValues() {
	...
	if err != nil {
		logger.Error(fmt.Sprintf("fail parse flag params: %v", err), map[string]interface{}{})
	}

	if flagValues.HasRunAddress() {
		err = Env.SetRunAddress(flagValues.GetRunAddress())
		if err != nil {
			logger.Error(fmt.Sprintf("fail set RunAddress from flag params: %v", err), map[string]interface{}{})
		}
	}
	...
	if flagValues.HasDBUri() {
		...
		if err != nil {
			logger.Error(fmt.Sprintf("fail set DBUri from flag params: %v", err), map[string]interface{}{})
		}
	}
	...
	if flagValues.HasAccrualSystemUrl() {
		...
		if err != nil {
			logger.Error(fmt.Sprintf("fail set AccrualSystemUrl from flag params: %v", err), map[string]interface{}{})
		}
	}
}
